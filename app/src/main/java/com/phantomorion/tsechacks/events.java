        ...
        crf.get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ArrayList<EventDetails> ed = (ArrayList<EventDetails>) queryDocumentSnapshots.toObjects(EventDetails.class);
                        mRecyclerViewEvents.setAdapter(new com.phantomorion.tsechacks.AdapterFiles.eventAdapter(ed));
                    }
                })
